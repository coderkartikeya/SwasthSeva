...
import { FaUserCircle, FaCommentDots, FaHistory, FaFileMedical, FaPhone, FaEnvelope, FaMapMarkerAlt, FaEdit, FaIdCard, FaCheckCircle } from 'react-icons/fa';
...
const PatientPage = () => {
  ...
  if (loading) {
    return (
      <div className="h-screen bg-slate-100">
        <SideNav name="main" />
        <div className="md:ml-[300px] md:pt-[50px] md:p-5 h-screen flex items-center justify-center">
  ...
  return (
    <div className="h-screen bg-slate-100">
      <SideNav name="main" />
      <div className="md:ml-[300px] md:pt-[50px] md:p-5 h-screen overflow-y-auto">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="pt-24 pb-8 px-8">
              <div className="flex items-center justify-between mb-2">
                <h1 className="text-4xl font-bold text-gray-900 dark:text-white">{patientData.patientName}</h1>
          ...
          >
            ...
            <div className="space-y-6">
              {patientData.recentComments.length > 0 ? (
                patientData.recentComments.map((comment, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
